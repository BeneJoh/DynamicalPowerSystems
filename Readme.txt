...
4. Install requirements in .venv with 'pip install -r requirements.txt' 
5. Open the 'test_me_before_friday.ipynb' file in your editor and run the code cells to test your system setup (see https://code.visualstudio.com/docs/datascience/jupyter-notebooks)
